...
[ EventParticipant, Event, PersonTag, Tag, GoogleCredential, MeetingProposal, Session, Person, User ].each(&:delete_all)
...
matchmaking_profiles = {
  rich_users[0] => { # user2@example.com — strong mutual match with Maya
  ...
  rich_users[1] => { # user3@example.com — also a good match for Maya
  ...
  rich_users[2] => { # user4@example.com — deliberate mismatch; expect a decline
